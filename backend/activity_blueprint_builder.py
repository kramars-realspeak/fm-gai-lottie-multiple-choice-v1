...
class FMGAILottieMultipleChoiceActivityBlueprintBuilder:
    ...
    def set_sentence(self):
        ...
        self.set_options(sentence["options"])
        self.set_correct_answer(sentence["correct_answer"])
    ...
    def set_options(self, options):
        self.activity.options = options
        self.logger.info(f"{self.__class__.__name__}: 'set_options' method invoked - Options set to: {self.activity.options}")
        return self

    def set_correct_answer(self, correct_answer):
        self.activity.correct_answer = correct_answer
