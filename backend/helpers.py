...
def make_activity_prompt(prompt: dict, target_vocabulary: list, data_point, personalize : bool,  students: list):
    ...
    activity_prompt = "Please generate an activity based on the following details:\n\n: "
    ...
    activity_prompt += (
        ...
        "    },\n"
        "    \"sentence\": \"<A clear and concise sentence which is a question or statement>\",\n"
        "    \"correct_answer\": \"<The correct answer for the activity, either A, B, C or D>\",\n"
        "    \"options\": {\n"
        "        \"A\": \"<Option A>\",\n"
        "        \"B\": \"<Option B>\",\n"
        "        \"C\": \"<Option C>\",\n"
