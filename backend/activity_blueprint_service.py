...
from backend.activity_blueprint_builder import FMGAILottieMultipleChoiceActivityBlueprintBuilder
...
class ActivityBlueprintService:
    def __init__(self):
        self.builder = FMGAILottieMultipleChoiceActivityBlueprintBuilder(Activity())
